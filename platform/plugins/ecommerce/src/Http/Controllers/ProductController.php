...
use Botble\Ecommerce\Http\Requests\ProductRequestEdit;
...
class ProductController extends BaseController
{
    ...
    public function store(
        ...
        if($files=$request->file('products_images_gallery')){
        ...
        $name='products-images/'.$request->input('sku').'/'.time().$randomString.'.'.$file->getClientOriginalExtension();
            $file->move(public_path('storage/products-images/'.$request->input('sku')), $name);
    ...
    public function update(
        ...
        foreach($files as $file){
        $randomString .= $characters[random_int(0, $charactersLength - 1)];
        $name='products-images/'.$product->sku.'/'.time().$randomString.'.'.$file->getClientOriginalExtension();
            $file->move(public_path('storage/products-images/'.$product->sku), $name);
