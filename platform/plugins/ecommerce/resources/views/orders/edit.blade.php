                                        ...
                                        <tbody>
                                            @foreach ($order->products as $orderProduct)
                                                ...
                                                @endphp
                                                   ...
                                                   <tr> <td class="width-120-px min-width-60-px vertical-align-t">
                                                        <div class="wrap-img border-none">
                                                            <img width="175" class=" thumb-image-cartorderlist" src="{{ RvMedia::getImageUrl($orderProduct->product_image, 'thumb', false, RvMedia::getDefaultImage()) }}" alt="{{ $orderProduct->product_name }}">
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="flexbox-auto-right pl5">
                                        <div class="table-wrap">
                                            <table class="table-normal table-none-border table-color-gray-text">
                                                ...
                                                <tr>
                                                    <td class="text-end color-subtext mt10">
                                                        <p class="mb0">{{ trans('plugins/ecommerce::order.shipping_fee') }} ({{ $order->shipping_method_name }})</p>
                                                    </td>
