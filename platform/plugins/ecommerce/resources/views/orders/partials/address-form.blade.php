<div class="customer-address-payment-form">
    ...
    @if (EcommerceHelper::isEnabledGuestCheckout() && ! auth('customer')->check())
        <div hidden @if(Session::get('otp')) hidden  @endif class="form-group mb-3">
...
@if(Session::get('otp'))
 ...
 <div class="row">
           <div class="col-md-2 checkout-button-group"></div>
           <div class="col-md-8 checkout-button-group">
         <div class="alert alert-success w-100 form-input-wrapper">{{ __('أدخل رمز التحقق الذي تم إرساله إلى رقم هاتفك') }} {{Session::get('phone')}}</div>
 
        <div class="form-group mt-4 @error('address.otp') has-error @enderror">
            <div class="form-input-wrapper ">
...
@endif 
        <div class="row">
            ...
            <div @if(Session::get('otp')) hidden @endif  class="col-lg-12 col-12">
        ...
        <div class="row">
            <div hidden class="col-sm-6 col-12">
