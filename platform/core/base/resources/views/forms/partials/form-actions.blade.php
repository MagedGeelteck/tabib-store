    ...
    <div class="widget-body">
        <div class="btn-set">
            ...
            <button type="submit" name="submit" value="apply" class="btn btn-success">
                <i class="fa fa-check-circle"></i> {{$saveAndContinueTitle ?? trans('core/base::forms.save_and_continue') }}
            </button>&nbsp;
            
            @if (!isset($onlySave) || ! $onlySave)
                <button type="submit" name="submit" value="save" class="btn btn-danger">
