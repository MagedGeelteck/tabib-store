@if(Route::currentRouteName()=="products.create" || Route::currentRouteName()=="products.edit")
...
<div class="gallery-images-wrapper list-images">
    ...
    <input type="file" name="products_images_gallery[]" multiple class="w-100 py-3">
    
    <div class="images-wrapper">
       
        <input type="hidden" name="{{ $name }}">
        <ul class="list-unstyled list-gallery-media-images"
            data-name="{{ $name }}"
