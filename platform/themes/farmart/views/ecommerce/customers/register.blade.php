                ...
                <div class="tab-content my-3">
                    <div class="tab-pane fade pt-4 show active" id="nav-register-content" role="tabpanel"
                        ...
                        <form method="POST" action="{{ route('customer.register.post') }}">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label required" for="email-register">{{ __('Phone') }}</label>
                                <input class="form-control @if ($errors->has('email')) is-invalid @endif"
                                       type="phone" required="required" placeholder="{{ __('079 *******') }}"
                                       name="phone" autocomplete="email" id="email-register" value="{{ old('phone') }}">
                                @if ($errors->has('phone'))
