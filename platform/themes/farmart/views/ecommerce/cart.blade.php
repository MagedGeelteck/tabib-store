                                ...
                                <tr class="cart-form__cart-item cart_item">
                                    <td class="product-thumbnail">
                                        ...
                                        <a href="{{ $product->original_product->url }}"
                                            ...
                                            <img class="lazyload" src="{{ image_placeholder(RvMedia::getImageUrl($product->images[0], 'thumb', false, RvMedia::getDefaultImage())) }}" data-src="{{ RvMedia::getImageUrl($product->images[0], 'thumb', false, RvMedia::getDefaultImage()) }}"
