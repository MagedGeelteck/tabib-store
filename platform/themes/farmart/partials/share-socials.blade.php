...
strip_tags(SeoHelper::getDescription()) }}" title="Pinterest" target="_blank">
    ...
    <li>
        ...
        <a class="share-instagram" href="https://www.instagram.com/shareArticle?mini=true&url={{ urlencode($product->url) }}&summary={{ rawurldecode(strip_tags(SeoHelper::getDescription())) }}" title="Linkedin" target="_blank">
            <span class="svg-icon">
                <svg>
