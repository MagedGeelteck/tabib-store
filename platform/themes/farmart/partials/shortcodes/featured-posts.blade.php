...
<div hidden class="widget-blog py-5 lazyload" @if ($shortcode->bg) data-bg="{{ RvMedia::getImageUrl($shortcode->bg) }}" @endif>
    <div class="container-xxxl">
        <div class="row">
            <div hidden class="@if ($shortcode->app_enabled) col-lg-8 @else col-12 @endif py-4 py-lg-0">
