<div class="col-auto">
    <div class="catalog-toolbar__view d-flex align-items-center">
        ...
        <div class="toolbar-view__icon">
            <a class="grid <?php if(request()->input('layout') != 'list'): ?> active <?php endif; ?>" href="#"
            ...
            <a class="list <?php if(request()->input('layout') == 'list'): ?> active <?php endif; ?>" href="#"
...
<?php /**PATH /home/tabibj5/public_html/platform/themes/farmart/views/ecommerce/includes/layout.blade.php ENDPATH**/ ?>