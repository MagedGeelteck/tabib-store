                ...
                <?php if($config['phone']): ?>
                    <li class="py-2">
                        ...
                        <span><?php echo e(__('Hotline 24/7:')); ?>
                            ...
                            <h4 class="ms-4 mt-2"><a href="tel:<?php echo e($config['phone']); ?>"><?php echo e($config['phone']); ?></a></h4>
                        </span>
                    </li>
                <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/tabibj5/public_html/platform/themes/farmart/////widgets/site-info/templates/frontend.blade.php ENDPATH**/ ?>